...
# Connection stuff
    ...
    def start(self):
        ...
        threading.Thread(target=self.pingSuccessoressor, args=()).start()
    ...
    def connectionThread(self, connection, address):
        ...
        # type 0: peer connect, type 1: client, type 2: ping, type 3: lookupID, type 4: updateSuccessor/Pred
        ...
        if connectionType == 0:
            ...
            if rDataList[1] == 1:
                self.updateSuccessor(rDataList)
            else:
                self.updatePredecessor(rDataList)
    ...
    def listenThread(self):
        ...
        while True:
            try:
                ...
                print(f"Error: Connection not accepted. {m}")
    ...
    def updateOtherFTables(self):
        ...
        while True:
            ...
            try:
                ...
                print(f"Socket error when updating other FingerTable: {m}")
